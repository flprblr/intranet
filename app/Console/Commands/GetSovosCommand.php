...
class GetSovosCommand extends Command
{
    /**
    ...
    public function handle()
    {
        ...
        try {
            ...
            foreach ($ecommerces as $ecommerce) {
                ...
                $orders = Order::select('id', 'invoice_number')
        ...
        Log::channel('sovos')->info('GET Sovos PDF: ' . $executionTime . ' seconds');
