    ...
    <div>
        ...
        <JetFormSection @submitted="createApiToken">
            ...
            <template #description>
                API tokens permiten que los servicios de terceros se autentiquen con nuestra aplicación en su nombre.
            </template>
            ...
            <template #form>
                ...
                <div v-if="availablePermissions.length > 0" class="col-span-6">
                    <JetLabel for="permissions" value="Permisos" />
        ...
        <div v-if="tokens.length > 0">
            ...
            <div class="mt-10 sm:mt-0">
                <JetActionSection>
                    <template #title>
                        Administrar API Tokens
                    </template>

                    <template #description>
                        Puedes eliminar cualquiera de sus tokens existentes si ya no los necesitas.
                    </template>
                            ...
                            <div v-for="token in tokens" :key="token.id" class="flex items-center justify-between">
                                ...
                                <div class="flex items-center">
                                    <div v-if="token.last_used_ago" class="text-sm text-gray-400">
                                        Último uso hace {{ token.last_used_ago }}
                                    </div>
