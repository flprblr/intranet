...
const form = useForm({
    id: props.extguarantees[0].id,

    rut: props.extguarantees[0].rut,
    full_name: props.extguarantees[0].full_name,
    phone: props.extguarantees[0].phone,
    email: props.extguarantees[0].email,
    xblnr: props.extguarantees[0].xblnr,
    sold_by: props.extguarantees[0].sold_by,
    sellername: props.extguarantees[0].sellername,
    fecha_emision: props.extguarantees[0].sold_date,
    matnr: props.extguarantees[0].matnr,
    tipo_material_sap: props.extguarantees[0].type,
    description: props.extguarantees[0].description,
    nro_serie_apple: props.extguarantees[0].serial,

    //GEXT
    xblnr_gext: props.extguarantees[0].xblnr_gext,
    matnr_gext: props.extguarantees[0].matnr_gext,
    description_gext: props.extguarantees[0].description_gext,
    valor_gext: props.extguarantees[0].valor,
    valid_from: props.extguarantees[0].valid_from,
    valid_to: props.extguarantees[0].valid_to,
    comment: props.extguarantees[0].comment,

});

const submit = () => {
    form.put(route("extguarantee.update", props.extguarantees[0].id))
};
                            ...
                            <div class="grid grid-cols-8 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input
                                        ...
                                        id="textoInput" type="text" autocomplete="id" v-model="form.id" readonly>
                                </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6 shadow">
                            <div class="grid grid-cols-8 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input
                                        class="border-gray-300 focus:border-gray-300 focus:ring focus:ring-gray-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"
                                        id="textoInput" type="text" autocomplete="rut" v-model="form.rut" required>
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input
                                        class="border-gray-300 focus:border-gray-300 focus:ring focus:ring-gray-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"
                                        id="full_name" type="text" autocomplete="name" v-model="form.full_name" required>
                                </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6 shadow">
                            <div class="grid grid-cols-8 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <select v-else
                                        class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-gray-500 focus:border-gray-500 sm:text-sm"
                                        id="matnr" v-model="form.matnr" :key="form.matnr">
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input
                                        class="border-gray-300 focus:border-gray-300 focus:ring focus:ring-gray-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"
                                        id="type" type="text" autocomplete="type" v-model="form.tipo_material_sap" readonly
                                        required>
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input
                                        class="border-gray-300 focus:border-gray-300 focus:ring focus:ring-gray-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"
                                        id="description" type="text" autocomplete="description" v-model="form.description"
                                        readonly required>
                                </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6 shadow">
                            <div class="grid grid-cols-8 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input
                                        class="border-gray-300 focus:border-gray-300 focus:ring focus:ring-gray-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"
                                        id="valid_to" type="date" autocomplete="valid_to" v-model="form.valid_to" required
                                        readonly>
                                </div>
                            </div>
                        </div>
